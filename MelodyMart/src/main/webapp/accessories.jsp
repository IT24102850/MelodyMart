...
<head>
    ...
    <title>MelodyMart - Accessories</title>
    <link rel="icon" type="image/x-icon" href="./images/favicon_io%20(9)/favicon.ico"/>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter:wght@400;700;900&family=Playfair+Display:wght@700&display=swap" rel="stylesheet"/>
...
<!-- Hero Section -->
<section class="flex flex-col md:flex-row items-center justify-between p-8 md:p-16 relative z-10">
    <div class="md:w-1/2 text-center md:text-left">
        <h1 class="hero-title">Accessorize Your Rhythm</h1>
        <a href="#accessory-grid" class="cta-button text-white text-lg font-semibold inline-block mt-4">Shop Now</a>
    </div>
